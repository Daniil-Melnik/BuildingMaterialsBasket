...
function getCheapestInCategory(products, category, region) {
 ...
 * @param {Object} order - объект заказа (содержит region, items, total, timestamp)
 */
...
function createOrderFile(order) {
  ...
  try {
    ...
    console.log();
    console.log(`Заявка сохранена: ${orderFile}`);
